      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`lg:flex lg:items-center lg:gap-16 ${imageOnRight ? '' : 'lg:flex-row-reverse'}`}>
          <div className="lg:w-1/2 mb-10 lg:mb-0">
            <h3 className="text-title1 font-bold text-gray-900 mb-6">{title}</h3>
            <p className="text-title3 text-gray-600 leading-relaxed mb-8">{description}</p>
          </div>
...
const FeatureDetail = () => {
  ...
  return <section className=" ">
      ...
      <DetailSection title="Lose weight, not your muscle and hair." description="Losing weight fast can affect your muscle mass and hair thickness. Log your body composition and hair health to catch any negative side effects early and stay on top of your GLP-1 journey." imageOnRight={true}>
        <img src={mockup1} alt="Muscle and Hair Tracker" className="w-full max-w-xs h-auto drop-shadow-2xl object-contain mx-auto" />
      </DetailSection>
      ...
      <DetailSection title="Understand your side effects." description="Log nausea, fatigue, constipation, and appetite changes. See if your symptoms correlate with shot days or dose increases." imageOnRight={true}>
        <img src={mockup3} alt="Side Effects Tracker" className="w-full max-w-xs h-auto drop-shadow-2xl object-contain mx-auto" />
      </DetailSection>
      ...
      <DetailSection title="Protect your muscle mass." description="Losing weight fast can mean losing muscle. Our Muscle Retention Score combines your protein intake, resistance training logs, and weight loss rate to ensure you're losing fat, not muscle." imageOnRight={true}>
         <Squircle className="bg-app-progress p-10 text-white shadow-2xl max-w-sm w-full text-center" cornerRadius={32} cornerSmoothing={1}>
            <h4 className="text-title3 font-medium mb-2">Muscle Retention Score</h4>
            <div className="text-display1 font-extrabold mb-4">92</div>
            <Squircle className="text-white font-medium bg-app-fiber py-2 px-4 inline-block" cornerRadius={100} cornerSmoothing={1}>Excellent Consistency</Squircle>
         </Squircle>
      </DetailSection>
